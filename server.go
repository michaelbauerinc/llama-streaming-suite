...
func runBin(outputChan chan<- string) {
        // cmd := exec.Command("bash", "-c", "/Volumes/dev/tmp/llama.cpp/lol -m /Volumes/dev/tmp/llama.cpp/model_bins/llama-2-7b-chat.ggmlv3.q8_0.bin -n 1024")
...
func main() {
        ...
        // glog.Infof("Serving...")
        glog.Fatal(http.ListenAndServe("0.0.0.0:8080", nil))
